...
/** @type {string} */
const CACHE_VERSION = '1753006507|4781990845';
/** @type {string} */
const CACHE_PREFIX = 'night-trucker-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'night-trucker.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["night-trucker.html","night-trucker.js","night-trucker.offline.html","night-trucker.icon.png","night-trucker.apple-touch-icon.png","night-trucker.audio.worklet.js","night-trucker.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["night-trucker.wasm","night-trucker.pck","night-trucker.side.wasm"];
